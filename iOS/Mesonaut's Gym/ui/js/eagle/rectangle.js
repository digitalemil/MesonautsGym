...
function Rectangle(w, h, irx, iry, irz, ir, ic) {
	this.init(w, h, irx, iry, irz, ir, ic);
}
...
//	console.log("scale rect: "+isx+" "+isy);
	this.width *= isx;
	this.height *= isy;
};
...
Rectangle.prototype.isIn = function(ix, iy) {
	if (ix >= this.coordtap.a11 && ix <= this.coordtap.a21
			&& iy >= this.coordtap.a12 && iy <= this.coordtap.a22)
		return true;
	return false;
};
