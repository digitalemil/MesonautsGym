...
function BoundingCircle(ir, irx, iry, irz) {
	this.initBoundingCircle(ir, irx, iry, irz);
}
...
//	return 4+3;
//	console.log("BC getNumberOfData: "+this.triangles+" "+this.maxeff);
	   if (visibleboundingcircle) {
           return 4 + 1+2 * (this.maxeff + 1); // type, n, color, correct
ion
   }
   return 4 + 3;
};
